...
//		IndexWord test = Dictionary.getInstance().getIndexWord(POS.NOUN, "dog");
//		System.out.println(test.getLemma());
		
		ACCOMPLISH = Dictionary.getInstance().getIndexWord(POS.VERB, "accomplish");
		DOG = Dictionary.getInstance().getIndexWord(POS.NOUN, "dog");
		CAT = Dictionary.getInstance().lookupIndexWord(POS.NOUN, "pen");

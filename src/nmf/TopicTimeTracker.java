...
public class TopicTimeTracker
{
  ...
  private static void printUsage()
  {
    ...
    System.out.println("inputpath - defines the path to a directory where the XML files generated by NMFTopicExtractor are contained. These XML files, each representing the topics of a certain time span, are then loaded into a topic river.");
    System.out.println("writeCSV - if \"1\", CSV visualization data will be written. This is the more advanced visualization tool.");
    System.out.println("writeJSON - if \"1\", JSON visualization data will be written.");
  }
}
